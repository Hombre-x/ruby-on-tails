...
public interface CorundumVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link CorundumParser#program}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitProgram(CorundumParser.ProgramContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link CorundumParser#clojure_definition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClojure_definition(CorundumParser.Clojure_definitionContext ctx);
	/**
	 * Visit a parse tree produced by {@link CorundumParser#clojure_definition_header}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClojure_definition_header(CorundumParser.Clojure_definition_headerContext ctx);
	/**
