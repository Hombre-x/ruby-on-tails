...
public interface CorundumListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link CorundumParser#program}.
	 * @param ctx the parse tree
	 */
	void enterProgram(CorundumParser.ProgramContext ctx);
	/**
	 * Exit a parse tree produced by {@link CorundumParser#program}.
	 * @param ctx the parse tree
	 */
	void exitProgram(CorundumParser.ProgramContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link CorundumParser#clojure_definition}.
	 * @param ctx the parse tree
	 */
	void enterClojure_definition(CorundumParser.Clojure_definitionContext ctx);
	/**
	 * Exit a parse tree produced by {@link CorundumParser#clojure_definition}.
	 * @param ctx the parse tree
	 */
	void exitClojure_definition(CorundumParser.Clojure_definitionContext ctx);
	/**
	 * Enter a parse tree produced by {@link CorundumParser#clojure_definition_header}.
	 * @param ctx the parse tree
	 */
	void enterClojure_definition_header(CorundumParser.Clojure_definition_headerContext ctx);
	/**
	 * Exit a parse tree produced by {@link CorundumParser#clojure_definition_header}.
	 * @param ctx the parse tree
	 */
	void exitClojure_definition_header(CorundumParser.Clojure_definition_headerContext ctx);
	/**
